...
function createChart(id,data,labels,label,r,g,b){ 
...
function createDoubleChart(id,data,labels,label,r,g,b,data2,label2,r2,g2,b2){ 
  var ctx = document.getElementById(id);
  var myLineChart = new Chart(ctx, {
    type: 'line',
    data: {
      ...
      },
      {
        label: label2,
        lineTension: 0.3,
        backgroundColor: "rgba("+r2+", "+g2+", "+b2+", 0.05)",
        borderColor: "rgba("+r2+", "+g2+", "+b2+", 1)",
        pointRadius: 3,
        pointBackgroundColor: "rgba("+r2+", "+g2+", "+b2+", 1)",
        pointBorderColor: "rgba("+r2+", "+g2+", "+b2+", 1)",
        pointHoverRadius: 3,
        pointHoverBackgroundColor: "rgba("+r2+", "+g2+", "+b2+", 1)",
        pointHoverBorderColor: "rgba("+r2+", "+g2+", "+b2+", 1)",
        pointHitRadius: 10,
        pointBorderWidth: 2,
        data: data2,
      }
